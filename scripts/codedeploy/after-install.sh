...
MONGODB_URI="mongodb://${DB_USER}:${DB_PASS}@${DB_HOST}:${DB_PORT}/appointy?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false&authSource=admin&tlsCAFile=/opt/appointy/global-bundle.pem"
